...
export const Form = ({ followUp, resetState, uuid }: { followUp: FollowUp | undefined, resetState: () => void, uuid: string }) => { // Update follow up form
      ...
      {followUp && (
        <div className="flex flex-col items-center">
          ...
          <DeleteBtn
            ...
            handleClick={() => handleDeleteBtnClick(uuid, state.deleteBtnActive, deleteFollowUp, { setState, resetState, invalidateQuery: () => queryClient.invalidateQueries(['getSite', siteUUID]) })} />
        </div>
      )}
    </>
  )
