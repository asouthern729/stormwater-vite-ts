...
// Types
import { SiteIllicitDischargeIndicatorProps } from './types'

function SiteIllicitDischargeIndicator({ discharges, disabled }: SiteIllicitDischargeIndicatorProps) {
  ...
  return (
    <button
      data-testid="site-illicit-discharge-indicator"
      type="button"
      disabled={disabled}
...
export default SiteIllicitDischargeIndicator