...
export const CalendarTypeBtn = (props: CalendarTypeBtnProps) => {
  ...
  return (
    <button 
      ...
      className="text-neutral-content font-[play] uppercase p-2 py-1 bg-transparent hover:bg-neutral">
        {props.children}
    </button>
  )
}
...
export const ActivityCalendarLegend = () => {
  ...
  return (
    <div className="flex gap-6 font-[play] text-sm font-bold uppercase p-4 bg-neutral flex-wrap justify-center m-auto w-fit">
...
const ActivityCalendarLegendItem = (props: ActivityCalendarLegendItemProps) => {
  ...
  return (
    <div className={`${ props.className } p-2 py-[2px] text-center w-[120px] rounded`}>{props.children}</div>
  )
}